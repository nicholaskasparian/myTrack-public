...
- `small_model` configures a lightweight model for title generation tasks
- `enabled_providers` acts as allowlist; `disabled_providers` takes priority if both are set
