...
* [Introduction](#introduction)* [Mock APIs](#mock-apis)* [Network mocking](#network-mocking)* [HTTP Authentication](#http-authentication)* [HTTP Proxy](#http-proxy)* [Network events](#network-events)* [Handle requests](#handle-requests)* [Modify requests](#modify-requests)* [Abort requests](#abort-requests)* [Modify responses](#modify-responses)* [Glob URL patterns](#glob-url-patterns)* [WebSockets](#websockets)* [Missing Network Events and Service Workers](#missing-network-events-and-service-workers)
