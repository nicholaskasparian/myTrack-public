...
* [Introduction](#introduction)* [Installing Playwright](#installing-playwright)
    + [Using npm, yarn or pnpm](#using-npm-yarn-or-pnpm)+ [Using the VS Code Extension](#using-the-vs-code-extension)* [What's Installed](#whats-installed)* [Running the Example Test](#running-the-example-test)* [HTML Test Reports](#html-test-reports)* [Running the Example Test in UI Mode](#running-the-example-test-in-ui-mode)* [Updating Playwright](#updating-playwright)* [System requirements](#system-requirements)* [What's next](#whats-next)
